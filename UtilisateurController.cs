        ...
        <div class="card-body">
            <form asp-action="GroupEdit">
                ...
                <div class="form-group">
                    ...
                    <select asp-for="SelectedUtilisateurs" class="form-control" multiple="multiple">
                        @foreach (var utilisateur in utilisateursWithService)
                        {
                            var isSelected = Model.GroupUtilisateurs.Any(gu => gu.UtilisateurId == int.Parse(utilisateur.Value));
                            <option value="@utilisateur.Value" data-service="@utilisateur.Group.Name" @(isSelected ? "selected" : "" )>@utilisateur.Text</option>
                        }
                    </select>
                </div>
                <div class="form-group">
